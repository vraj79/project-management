      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
          ...
          <div className="flex items-center gap-1">
            <button className="flex h-6 w-6 cursor-pointer items-center justify-center dark:text-neutral-500">
              <EllipsisVertical size={26} />
            </button>
            <div
              onClick={() => setIsModalNewTaskOpen(true)}
              className="flex h-6 w-6 cursor-pointer items-center justify-center rounded bg-gray-200 dark:bg-dark-tertiary dark:text-white"
            >
              <Plus size={16} />
            </div>
          </div>
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                src={`https://vraj-pm-s3-images.s3.us-east-1.amazonaws.com/${task?.assignee?.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                src={`https://vraj-pm-s3-images.s3.us-east-1.amazonaws.com/${task?.author?.profilePictureUrl!}`}
          ...
          <div className="flex items-center text-gray-500 dark:text-neutral-50">
